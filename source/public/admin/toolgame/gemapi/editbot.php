...
{
    $row = $SIEUTHICODE->get_row(" SELECT * FROM `nrogem_info_bot` WHERE `id` = '".Anti_xss($_GET['id'])."'  ");
    if(!$row)
    {
...
if (isset($_POST['UpdateBot']) && $getUser['level'] == 'admin') {
    ...
    $isInsert = $SIEUTHICODE->update("nrogem_info_bot", [
        ...
        <div class="container-fluid">
            <div class="row">
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10" href="/Admin/toolgame/nrogem-info-bot"
