...
$title = 'Bán ngọc NRO - Thống kê giao dịch | ' . $SIEUTHICODE->site('tenweb');
...
if(!empty($_GET['account'])){
    $account = Anti_xss($_GET['account']);
    $where .= ' AND `user` = "'.$account.'" ';
}
...
$listOrder = $SIEUTHICODE->get_list(" SELECT * FROM `history_gem_api_nro` WHERE $where ORDER BY id DESC LIMIT $from,$sotin1trang ");
$dataSumary = $SIEUTHICODE->get_list("SELECT * FROM `history_gem_api_nro` WHERE $where");
$totalGemNumber = 0;
$totalTransactions = 0;
$totalAmount = 0;
...
foreach ($dataSumary as $transaction) {
    $totalGemNumber += $transaction['gem_number'];
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Bán ngọc NRO - Thống kê giao dịch</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bán ngọc NRO - Thống kê giao dịch</h3>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-3 col-12 col-sm-6 col-lg-3">
                                                ...
                                                <input type="text" class="form-control" value="<?=$account;?>"
                                                    name="account" placeholder="Tài khoản game">
                                            </div>
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                ...
                                                <a class="btn btn-danger"
                                                    href="/Admin/toolgame/nrogem-logtransaction"><i
                                                        class="fa fa-trash"></i>
                                                    Reset
                                                </a>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                                    Số ngọc bán: <b><?=format_cash($totalGemNumber)?></b>
                                </div>
                                <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                                    Số đơn đang xử lý: <b><?=format_cash($status0Transactions)?></b>
                                </div>
                                <div class="col-lg-12 m--margin-bottom-10-tablet-and-mobile" style="font-size: 14px ">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>Tài khoản game: <b style="color:blue;"><?=$row['user'];?></b>
                                                    </li>
                                                    <li>Mật khẩu game: <b style="color:blue;"><?=$row['pass'];?></b>
                                                    </li>
                                                    <li>Thanh toán: <b
                                                            style="color:red;"><?=format_cash($row['cash']);?>đ</b>
                                                    </li>
                                                    <li>Số ngọc nhận: <b
                                                            style="color:green;"><?= format_cash($row['gem_number']); ?></b>
                                                    </li>
                                                </ul>
                                            </td>
                                            <td><?=$row['note'];?></td>
                                            <td><?=status_history_nrogem_admin($row['status']);?></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <?php
                                $total = $SIEUTHICODE->num_rows(" SELECT * FROM `history_gem_api_nro` WHERE $where ORDER BY id DESC ");
                                if ($total > $sotin1trang){echo '<center>' . pagination(BASE_URL("Admin/toolgame/nrogem-api-logtransaction?transid=$transid&username=$username&server=$server&account=$account&create_date=$create_date&"), $from, $total, $sotin1trang) . '</center>';}?>
                                </div>
                            </div>
                        </div>
                    </div>
