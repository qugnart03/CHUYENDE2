...
if (isset($_POST['AddCoin']) && $getUser['level'] == 'admin') {
    ...
    $isInsert = $SIEUTHICODE->insert("gem_api_nro", [
    ...
    if ($isInsert) {
        ...
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "' . BASE_URL('Admin/toolgame/nrogem-api-usernap') . '";}</script>');
    } else {
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Bán ngọc NRO - Thông tin bot nạp</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('Admin/Home');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Bán ngọc NRO - Thông tin bot nạp</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10"
                            href="<?=base_url('Admin/toolgame/nrogem-api-usernap');?>" type="button"><i
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Bán ngọc NRO - Thông tin bot nạp
                            </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="factor" placeholder="Hệ số"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
