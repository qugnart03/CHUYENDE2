...
if (isset($_POST['AddBot']) && $getUser['level'] == 'admin') {
    ...
    $isInsert = $SIEUTHICODE->insert("nrocoin_info_bot", [
    ...
    if ($isInsert) {
        $SIEUTHICODE->insert("logs", [
            ...
            'create_date' => gettime(),
            'action' => "Thêm bot vàng server (" . Anti_xss($_POST['server_nro']) . ") vào hệ thống.",
        ]);
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "' . BASE_URL('Admin/toolgame/nrocoin-info-bot') . '";}</script>');
    } else {
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Bán vàng NRO - Bot</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('Admin/Home');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Bán vàng NRO - Bot</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10"
                            href="/Admin/toolgame/nrocoin-info-bot" type="button"><i
