...
if (isset($_POST['AddCoin']) && $getUser['level'] == 'admin') {
    ...
    $isInsert = $SIEUTHICODE->insert("coin_nro_lau", [
    ...
    if ($isInsert) {
        ...
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "' . BASE_URL('Admin/toolgame/nrocoinlau-usernap') . '";}</script>');
    } else {
                ...
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10"
                            href="<?=base_url('Admin/toolgame/nrocoinlau-usernap');?>" type="button"><i
