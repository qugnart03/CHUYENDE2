        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <section class="col-lg-6 text-right">
                    <div class="mb-3">
                        <a class="btn btn-primary btn-icon-left m-b-10" href="<?=BASE_URL('Admin/toolgame/nrogem-usernap/create');?>"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datatable" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($SIEUTHICODE->get_list("SELECT * FROM `gem_nro` ORDER BY `server_nro` ASC") as $info):?>
                                        <tr>
                                            <td><?=$info['id']?></td>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm"
                                                    href="/Admin/toolgame/nrogem-usernap/edit/<?=$info['id']?>"><i
                                                        class="fa fa-pen"></i></a>
...
function delete_id(id) {
    ...
    if (confirm(text) == true) {
        $.ajax({
            url: '/Model/Admin/BotNapGem/Delete',
            type: 'POST',
            dataType: 'JSON',
            data: {
                id
