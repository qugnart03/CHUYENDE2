...
$listOrder = $SIEUTHICODE->get_list(" SELECT * FROM `history_gem_nro` WHERE $where ORDER BY id DESC LIMIT $from,$sotin1trang ");
$dataSumary = $SIEUTHICODE->get_list("SELECT * FROM `history_gem_nro` WHERE $where");
$totalGemNumber = 0;
$totalTransactions = 0;
$totalAmount = 0;
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <?php
                                $total = $SIEUTHICODE->num_rows(" SELECT * FROM `history_gem_nro` WHERE $where ORDER BY id DESC ");
                                if ($total > $sotin1trang){echo '<center>' . pagination(BASE_URL("Admin/toolgame/nrogem-logtransaction?transid=$transid&username=$username&server=$server&player=$player&create_date=$create_date&"), $from, $total, $sotin1trang) . '</center>';}?>
                                </div>
                            </div>
                        </div>
                    </div>
