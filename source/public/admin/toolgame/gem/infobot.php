        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <section class="col-lg-6 text-right">
                    <div class="mb-3">
                        <a class="btn btn-primary btn-icon-left m-b-10" href="/Admin/toolgame/nrogem-info-bot/create"
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Bán ngọc NRO - Bot</h3>
                                ...
                                <table id="datatable" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$info['player'];?></td>
                                            <td><?=format_cash($info['gem_number'])?></td>
                                            <td><?=$info['location']?></td>
                                            <td><?=$info['zone']?></td>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm"
                                                    href="/Admin/toolgame/nrogem-info-bot/edit/<?=$info['id']?>"><i
                                                        class="fa fa-pen"></i></a>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title_banngoc" placeholder=""
                                                value="<?=$SIEUTHICODE->site('title_banngoc')?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Giao dịch ảo</label>
                                            <input type="number" class="form-control" name="fake_gem" placeholder=""
                                                value="<?=$SIEUTHICODE->site('fake_gem')?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="logo_banngoc">
                                    ...
                                    <div class="col-6">
                                        <img width="500px" src="<?=BASE_URL($SIEUTHICODE->site('logo_banngoc'))?>" />
                                        <hr>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                    <select class="form-control select2bs4" name="status_gem_nro">
                                        <option <?=$SIEUTHICODE->site('status_gem_nro') == 1 ? 'selected' : '';?>
                                            value="1">ON
                                        </option>
                                        <option <?=$SIEUTHICODE->site('status_gem_nro') == 0 ? 'selected' : '';?>
                                            value="0">
                                            OFF
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="notice_banngoc"
                                        name="notice_banngoc"><?=$SIEUTHICODE->site('notice_banngoc')?></textarea>
                                </div>
                            </div>
...
CKEDITOR.replace("notice_banngoc");
$(function() {
    $("#datatable").DataTable({
        "responsive": true,
        "autoWidth": false,
