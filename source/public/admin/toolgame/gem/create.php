...
if (isset($_POST['AddCoin']) && $getUser['level'] == 'admin') {
    ...
    $isInsert = $SIEUTHICODE->insert("gem_nro", [
    ...
    if ($isInsert) {
        ...
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "' . BASE_URL('Admin/toolgame/nrogem-usernap') . '";}</script>');
    } else {
                ...
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10"
                            href="<?=base_url('Admin/toolgame/nrogem-usernap');?>" type="button"><i
