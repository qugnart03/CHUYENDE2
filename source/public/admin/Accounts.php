                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datatable1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach($SIEUTHICODE->get_list("SELECT * FROM `accounts` WHERE `groups` = '".$row['id']."' ORDER BY `id` DESC") as $info):
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info btn-sm"
                                                    href="/Admin/Account/Edit/<?=$info['id']?>" target="_blank"><i
