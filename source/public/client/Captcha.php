...
$captchaText = generateRandomString(rand(3,4));
...
$textColors = array(
    imagecolorallocate($image, 255, 0, 0),    // Màu đỏ
    imagecolorallocate($image, 0, 255, 0),    // Màu xanh lá cây
    imagecolorallocate($image, 0, 0, 255),    // Màu xanh dương
    imagecolorallocate($image, 255, 0, 255),  // Màu tím
    imagecolorallocate($image, 0, 255, 255)   // Màu xanh lam
);
